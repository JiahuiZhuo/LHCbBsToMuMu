...
The sister decay $B^0 \to \mu^+\mu^-$ is further CKM-suppressed,
...
the LHCb dimuon mass resolution at these masses is $\sigma \approx 23\
\mathrm{MeV}/c^2$, so the two peaks (separated by $87.2\ \mathrm{MeV}/c^2$,
